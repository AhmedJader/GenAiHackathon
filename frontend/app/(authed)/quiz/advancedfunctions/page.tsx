    ...
    <main className="relative min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 animate-fade-down">
      ...
      <div className="relative h-[70vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-black/50 backdrop-blur-sm flex justify-between items-center px-40">
          ...
          {/* Quiz Card */}
          <div className="bg-white/95 p-8 rounded-2xl shadow-2xl w-96 backdrop-blur-lg border border-gray-100">
            ...
            <p className="text-gray-600 mt-2">
              Perfect for students starting their journey.
            </p>
            <Link
              href="/quiz/advancedfunctions/questions"
          ...
          <div className="bg-blue-400 p-[1px] rounded-2xl shadow-2xl w-96 transform hover:scale-105 transition-all duration-300">
            <div className="bg-white p-8 rounded-2xl h-full">
              <div className="flex items-center gap-3 mb-4">
                ...
                <p className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 font-bold text-xl">
                  AI Assistant
                </p>
              </div>
              ...
              <p className="text-gray-600 mt-2">
                Get instant help with challenging concepts and problem-solving.
              </p>
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="bg-white/95 p-8 rounded-2xl shadow-xl backdrop-blur-md hover:shadow-2xl transition-all duration-300">
              <p className="text-xl text-gray-700 leading-relaxed">
                Advanced Functions (Grade 12) is a comprehensive mathematics
                course that builds upon fundamental algebraic concepts. This
                course is designed to deepen your understanding of functions and
            ...
            <div className="mt-8">
              <Link href="/quiz/advancedfunctions/questions">
                <Button
                  size="lg"
                  className="w-full bg-green-400 hover:bg-green-300 text-xl py-8 rounded-xl shadow-lg transform hover:-translate-y-1 transition-all duration-300"
                >
