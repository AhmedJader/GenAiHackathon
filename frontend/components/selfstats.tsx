...
export default function SelfHostedPower() {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 bg-gray-900 text-white rounded-xl shadow-lg">
      <h2 className="text-2xl font-bold">🔋 Self-Hosted Llama3 Power Usage</h2>
      ...
      <p className="text-lg">
        Power per Query: {POWER_PER_QUERY.toFixed(8)} kWh
      </p>
      <p className="text-lg">
        Cost per Query: ${COST_PER_QUERY.toFixed(8)} CAD
      </p>
      <p className="text-lg">
        CO₂ per Query: {CO2_PER_QUERY.toFixed(8)} kg
      </p>
